...
<!-- font CSS -->
<link href='//fonts.googleapis.com/css?family=Roboto:400,100,100italic,300,300italic,400italic,500,500italic,700,700italic,900,900italic' rel='sqylesheet' type='text/css'>
<!-- font-awesome icons -->
...
<div class="w3layouts-main">
	...
	<p style="color:red;font-weight: bold;">
		...
		{{
			Session::get('loginrequire')
		}}

		<?php Session::forget('loginrequire'); ?>
	</p>
	<p style="color:red;font-weight: bold;">
		...
		<form action="{{URL::to('/checkloginad')}}" method="post">
			{{csrf_field()}}
			<input type="text" class="ggg" name="username" placeholder="USERNAME" required="">
			<input type="password" class="ggg" name="password" placeholder="PASSWORD" required="">
			<h6><a href="https://www.facebook.com/profile.php?id=100016711454312">Forgot Password?</a></h6>
